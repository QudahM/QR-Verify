    ...
    <section className="py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {[
          ...
          <div key={i} className="group animate-fade-in" style={{ animationDelay: `${0.1 * (i + 1)}s` }}>
            <div className="glass h-full flex flex-col justify-start bg-glass-bg/50 border border-glass-border rounded-2xl p-8 hover:bg-glass-                               bg/70 transition-all duration-300 hover:scale-105 hover:shadow-glass">
